    ...
    items: [
      {
        ...
        features: ["Textbook Solutions", "SCERT Notes", "Previous Papers"],
    ...
    items: [
      {
        ...
        features: ["Semester Notes", "Model Papers", "Solved Papers"],
  ...
  "kerala-psc": {
    ...
    items: [
      ...
      },
      {
        ...
        features: ["GK Compendium", "Previous Papers", "Daily Tests"],
        color: "from-emerald-500 to-teal-600",
        icon: Users,
      },
      {
      ...
      },
      {
        ...
        features: ["Civil / Mechanical / EE", "Technical MCQs", "Previous Papers"],
      ...
      },
      {
        ...
        features: ["CPC / CrPC", "Kerala Court Rules", "Law Papers"],
