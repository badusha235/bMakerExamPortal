    ...
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
        <motion.div 
          ...
          className="bg-white p-10 rounded-[3rem] shadow-premium border border-slate-100 max-w-md w-full text-center"
        >
          <div className="w-20 h-20 bg-emerald-100 text-emerald-600 rounded-3xl flex items-center justify-center mx-auto mb-6">
            <CheckCircle2 size={40} />
          </div>
          <h2 className="text-3xl font-black text-slate-900 mb-4">Registration <span className="text-emerald-500">Successful!</span></h2>
          <p className="text-slate-500 font-medium mb-8">Your account has been created. Redirecting you to login...</p>
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black text-slate-900 mb-2">Create <span className="text-brand-blue">Account</span></h1>
          <p className="text-slate-500 font-medium tracking-tight text-sm">Join the bMakerStudyHub community today.</p>
        </div>
        ...
        <div className="bg-white p-8 md:p-10 rounded-[2.5rem] shadow-premium border border-slate-100">
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  type="text"
                  required
                  className="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-slate-900 focus:outline-none focus:ring-4 focus:ring-brand-blue/10 focus:border-brand-blue transition-all text-sm"
                  placeholder="johndoe"
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs font-black uppercase tracking-widest text-slate-400">
              <span className="bg-white px-4 italic">Or register with</span>
            </div>
          </div>
        ...
        <p className="text-center mt-8 text-slate-500 font-medium tracking-tight text-sm">
          Already have an account? <Link href="/login" className="text-brand-blue font-bold hover:underline">Sign In</Link>
        </p>
      </motion.div>
    </div>
  );
