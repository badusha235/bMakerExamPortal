...
export default function AdminPapersPage() {
  ...
  useEffect(() => {
    fetch("http://localhost:8000/api/exams/important-topics/")
      .then(res => res.json())
      .then(data => {
    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <main className="flex-1 ml-72 p-8 md:p-12">
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
          <div>
            <h1 className="text-3xl font-black text-slate-900 tracking-tight">Important <span className="text-brand-blue">Topics</span></h1>
            <p className="text-slate-500 font-medium">Highlight key areas and exam weightage for students.</p>
          </div>
          <Link 
          ...
          >
            <Plus size={20} className="text-brand-blue" /> Add Topic
          </Link>
        </header>
